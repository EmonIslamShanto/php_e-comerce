                            ...
                            <form action="code.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name" value="<?= $data['name'] ?>" placeholder="Enter catagory name" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary" name="update_catagory_btn">Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
