                    ...
                    <form action="code.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" placeholder="Enter catagory name" class="form-control">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary" name="add_catagory_btn">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
